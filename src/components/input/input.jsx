...
const input = ({onInputChange, placeholder, name, type, color}) => {
  ...
  return (
    ...
    <label className="block flex">
        <span className="block  text-slate-300 font-normal  w-1/5  font-bold flex items-center" 
              style={{ color: `${color}` }}>
                     {placeholder}
        </span>
        ...
        className='
           ...
           focus:invalid:border-pink-500 focus:invalid:ring-pink-500  font-bold
        '
